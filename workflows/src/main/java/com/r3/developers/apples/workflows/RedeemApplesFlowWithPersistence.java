...
//
///**
// * RedeemApplesFlowWithPersistence:
// * リンゴの引換券と箱詰めされたリンゴを交換するFlow。
// * 購入者は引換券を消費して、リンゴの所有者となる。
// */
//@InitiatingFlow(protocol = "redeem-apples-with-persistence")
//public class RedeemApplesFlowWithPersistence implements ClientStartableFlow {
//
//    @CordaInject
